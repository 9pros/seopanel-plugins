...
if (!file_exists($spLoadFile)) {
    $dirpath = str_ireplace('/plugins/socialmediaengine/socialmediaenginecron.php', '', $_SERVER['SCRIPT_FILENAME']);
    $spLoadFile = $dirpath."/includes/sp-load.php";
...
if ($spLoadFileExist) {
    ...
    if (empty($_SERVER['REQUEST_METHOD'])) {
        ...
        $pluginInfo = $controller->__getSeoPluginInfo('socialmediaengine', 'name');
