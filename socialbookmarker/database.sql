...
CREATE TABLE IF NOT EXISTS `sb_projects` (
  ...
  `last_shared_id` int(11) NOT NULL DEFAULT '0',
  `last_shared_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `sb_settings` (`id`, `set_label`, `set_name`, `set_val`, `set_type`) VALUES
(1, 'Allow user to access project manager', 'SB_ALLOW_USER_PRJ_MGR', '1', 'bool'),
(2, 'Allow user to access social bookmarker manager', 'SB_ALLOW_USER_SB_MGR', '1', 'bool');

CREATE TABLE IF NOT EXISTS `sb_texts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` varchar(8) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'en',
  `category` varchar(32) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'socialbookmarker',
...
INSERT INTO `sb_texts` (`id`, `lang_code`, `category`, `label`, `content`, `changed`) VALUES
(1, 'en', 'socialbookmarker', 'Plugin Settings', 'Plugin Settings', '2011-03-09 19:40:52'),
(2, 'en', 'socialbookmarker', 'SB_ALLOW_USER_PRJ_MGR', 'Allow user to access project manager', '2011-03-09 19:59:34'),
(3, 'en', 'socialbookmarker', 'settingssaved', 'Plugin settings saved successfully!', '2011-03-09 20:05:59'),
(4, 'en', 'socialbookmarker', 'Projects Manager', 'Projects Manager', '2011-03-09 20:41:52'),
(5, 'en', 'socialbookmarker', 'New Project', 'New Project', '2011-03-09 20:56:42'),
(9, 'en', 'socialbookmarker', 'Project already exist', 'Project already exist', '2011-03-10 20:04:14'),
(12, 'en', 'socialbookmarker', 'Run Project', 'Run Project', '2011-03-16 18:42:33'),
(35, 'en', 'socialbookmarker', 'Tags', 'Tags', '2011-08-09 17:38:52'),
(32, 'en', 'socialbookmarker', 'No active projects found', 'No active projects found', '2011-04-06 19:21:41'),
(33, 'en', 'socialbookmarker', 'croncommandtextsubmit', 'Add following command to your cron tab for submitting comments to blogs twice in an hour', '2011-04-06 20:27:01'),
(34, 'en', 'socialbookmarker', 'SB_ALLOW_USER_SUBMIT_COMM', 'Allow user to share links to social bookmarking sites', '2011-04-07 19:26:42'),
(36, 'en', 'socialbookmarker', 'Social Bookmarker', 'Social Bookmarker', '2011-09-01 20:34:23'),
(37, 'en', 'socialbookmarker', 'Social Bookmarker Manager', 'Social Bookmarker Manager', '2011-09-13 15:51:26'),
(38, 'en', 'socialbookmarker', 'New Social Bookmarker', 'New Social Bookmarker', '2011-09-13 17:59:36'),
(39, 'en', 'socialbookmarker', 'Edit Social Bookmarker', 'Edit Social Bookmarker', '2011-09-13 19:45:18'),
(40, 'en', 'socialbookmarker', 'Submit Link', 'Submit Link', '2011-09-13 19:59:32'),
(41, 'en', 'socialbookmarker', 'Register Link', 'Register Link', '2011-09-13 20:06:20'),
(42, 'en', 'socialbookmarker', 'Login Link', 'Login Link', '2011-09-13 20:06:20'),
(43, 'en', 'socialbookmarker', 'ranknote', 'Highest rank is 1, Please give rank according to priority of website', '2011-09-14 06:14:32'),
(44, 'en', 'socialbookmarker', 'Social bookmarker already exist!', 'Social bookmarker already exist!', '2011-09-14 06:37:33'),
(45, 'en', 'socialbookmarker', 'Show in iframe', 'Show in iframe', '2011-09-23 06:24:43'),
(46, 'en', 'socialbookmarker', 'popupnote', 'Please submit the link from popup window. If popup window is not displayed, please change the popup settings for this site.', '2011-09-23 06:50:49'),
(47, 'en', 'socialbookmarker', 'SB_ALLOW_USER_SB_MGR', 'Allow user to access social bookmarker manager', '2011-09-23 07:00:10'),
(48, 'en', 'socialbookmarker', 'Separate tags with commas', 'Separate tags with commas', '2011-09-23 07:12:16'),
(49, 'en', 'socialbookmarker', 'Last Shared', 'Last Shared', '2011-09-23 07:25:07'),
(50, 'en', 'socialbookmarker', 'Previous', 'Previous', '2011-09-23 07:29:19'),
(51, 'en', 'socialbookmarker', 'Next', 'Next', '2011-09-23 07:29:29'),
(52, 'en', 'socialbookmarker', 'No active websites found!', 'No active websites found!', '2011-09-23 19:06:19'),
(53, 'en', 'socialbookmarker', 'submisioncompleted', 'Project submission completed. No active social bookmarking site is left to submit.', '2011-09-23 19:20:59');