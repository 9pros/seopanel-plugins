...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
	<tr class="listHead">
		<td class="left" width='30%'><?=$pluginText['New Project']?></td>
		<td class="right">&nbsp;</td>
	</tr>		
	<tr class="white_row">
	...
	<tr class="blue_row">
		...
		<td class="td_right_col">
			<input type="text" id='weburl' name="share_url" value="<?=$post['share_url']?>" class="large"><?=$errMsg['share_url']?>
	...
	<tr class="white_row">
		...
		<td class="td_right_col">
			<input type="text" name="share_title" id="webtitle" value="<?=$post['share_title']?>" class="large"><?=$errMsg['share_title']?>
		</td>
	</tr>	
	<tr class="blue_row">
