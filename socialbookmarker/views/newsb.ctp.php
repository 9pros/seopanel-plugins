<?php echo showSectionHead($pluginText['New Social Bookmarker']); ?>
<form id="sbform">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
	<tr class="listHead">
		<td class="left" width='30%'><?=$plugintext['New Social Bookmarker']?></td>
		<td class="right">&nbsp;</td>
	</tr>		
	<tr class="white_row">
	...
	<tr>
    	<td style="padding-top: 6px;text-align:right;">
    		<a onclick="<?=pluginGETMethod('&action=showsbmanager', 'content')?>" href="javascript:void(0);" class="actionbut">
         	...
         	<?php $actFun = SP_DEMO ? "alertDemoMsg()" : pluginPOSTMethod('sbform', 'content', 'action=createsb'); ?>
